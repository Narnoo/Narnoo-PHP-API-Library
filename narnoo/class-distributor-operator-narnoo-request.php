...
class DistributorOperatorNarnooRequest extends NarnooRequest {
	...
	/* Distributors->Operator Media Requests*/
	...
	function searchMedia($business_name,$country,$state,$category,$subcategory,$suburb,$location,$postal_code,$latitude,$longitude,$keywords){
